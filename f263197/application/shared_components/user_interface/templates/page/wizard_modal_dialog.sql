...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(53518505403046916842)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518505741452916842)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518506093505916843)
,p_page_template_id=>wwv_flow_imp.id(53518505403046916842)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518506351670916843)
,p_page_template_id=>wwv_flow_imp.id(53518505403046916842)
