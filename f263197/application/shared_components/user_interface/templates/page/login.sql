...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(53518486886778916833)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518487179298916834)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518487482894916834)
,p_page_template_id=>wwv_flow_imp.id(53518486886778916833)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518487707388916834)
,p_page_template_id=>wwv_flow_imp.id(53518486886778916833)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518488095149916834)
,p_page_template_id=>wwv_flow_imp.id(53518486886778916833)
,p_name=>'Body Footer'
