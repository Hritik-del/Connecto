...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(53518496827420916838)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518497108209916838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518497462418916838)
,p_page_template_id=>wwv_flow_imp.id(53518496827420916838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518497723491916838)
,p_page_template_id=>wwv_flow_imp.id(53518496827420916838)
