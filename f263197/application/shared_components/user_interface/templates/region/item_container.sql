...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518971077189916874)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518971307731916874)
,p_plug_template_id=>wwv_flow_imp.id(53518971077189916874)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518971665485916874)
,p_plug_template_id=>wwv_flow_imp.id(53518971077189916874)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518971950285916874)
,p_plug_template_id=>wwv_flow_imp.id(53518971077189916874)
,p_name=>'Button Start'
