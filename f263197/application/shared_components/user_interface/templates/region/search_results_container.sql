...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518976059703916876)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518976488029916876)
,p_plug_template_id=>wwv_flow_imp.id(53518976059703916876)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518976784978916876)
,p_plug_template_id=>wwv_flow_imp.id(53518976059703916876)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518977011474916876)
,p_plug_template_id=>wwv_flow_imp.id(53518976059703916876)
,p_name=>'Sub Regions'
