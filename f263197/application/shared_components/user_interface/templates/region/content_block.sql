...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518940841380916860)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518941139323916860)
,p_plug_template_id=>wwv_flow_imp.id(53518940841380916860)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518941449791916860)
,p_plug_template_id=>wwv_flow_imp.id(53518940841380916860)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518941730914916861)
,p_plug_template_id=>wwv_flow_imp.id(53518940841380916860)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518942044424916861)
,p_plug_template_id=>wwv_flow_imp.id(53518940841380916860)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518942300962916861)
,p_plug_template_id=>wwv_flow_imp.id(53518940841380916860)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518942622748916861)
,p_plug_template_id=>wwv_flow_imp.id(53518940841380916860)
,p_name=>'Sub Regions'
