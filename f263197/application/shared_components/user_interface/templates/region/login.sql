...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518973537027916875)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518973854457916875)
,p_plug_template_id=>wwv_flow_imp.id(53518973537027916875)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518974189869916875)
,p_plug_template_id=>wwv_flow_imp.id(53518973537027916875)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518974484870916875)
,p_plug_template_id=>wwv_flow_imp.id(53518973537027916875)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518974786229916875)
,p_plug_template_id=>wwv_flow_imp.id(53518973537027916875)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518975091658916876)
,p_plug_template_id=>wwv_flow_imp.id(53518973537027916875)
,p_name=>'Sub Regions'
