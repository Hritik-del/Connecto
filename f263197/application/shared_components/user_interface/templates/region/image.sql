...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518948949475916864)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518949227999916864)
,p_plug_template_id=>wwv_flow_imp.id(53518948949475916864)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518949562691916864)
,p_plug_template_id=>wwv_flow_imp.id(53518948949475916864)
,p_name=>'Sub Regions'
