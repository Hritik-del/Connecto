...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518958950969916869)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518959261072916869)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518959595968916869)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518959840909916869)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518960112774916869)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518960492176916869)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518960783116916869)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518961058939916869)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518961360367916870)
,p_plug_template_id=>wwv_flow_imp.id(53518958950969916869)
,p_name=>'Sub Regions'
