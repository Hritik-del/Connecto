...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518954318305916866)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518954605344916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518954988646916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518955295767916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518955571305916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518955816643916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518956107712916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518956491423916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518956705212916867)
,p_plug_template_id=>wwv_flow_imp.id(53518954318305916866)
,p_name=>'Sub Regions'
