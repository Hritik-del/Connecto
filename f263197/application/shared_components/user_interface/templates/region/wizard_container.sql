...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518996363639916885)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518996620295916886)
,p_plug_template_id=>wwv_flow_imp.id(53518996363639916885)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518996983401916886)
,p_plug_template_id=>wwv_flow_imp.id(53518996363639916885)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518997266846916886)
,p_plug_template_id=>wwv_flow_imp.id(53518996363639916885)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518997527178916886)
,p_plug_template_id=>wwv_flow_imp.id(53518996363639916885)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518997893976916886)
,p_plug_template_id=>wwv_flow_imp.id(53518996363639916885)
