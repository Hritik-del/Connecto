...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518912102960916847)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518912438518916847)
,p_plug_template_id=>wwv_flow_imp.id(53518912102960916847)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518912757140916847)
,p_plug_template_id=>wwv_flow_imp.id(53518912102960916847)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518913076842916847)
,p_plug_template_id=>wwv_flow_imp.id(53518912102960916847)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518913364579916847)
,p_plug_template_id=>wwv_flow_imp.id(53518912102960916847)
,p_name=>'Sub Regions'
