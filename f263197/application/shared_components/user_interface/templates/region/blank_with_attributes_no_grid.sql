...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518913533058916847)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518913863526916848)
,p_plug_template_id=>wwv_flow_imp.id(53518913533058916847)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518914119441916848)
,p_plug_template_id=>wwv_flow_imp.id(53518913533058916847)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518914434160916848)
,p_plug_template_id=>wwv_flow_imp.id(53518913533058916847)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518914717117916848)
,p_plug_template_id=>wwv_flow_imp.id(53518913533058916847)
,p_name=>'Sub Regions'
