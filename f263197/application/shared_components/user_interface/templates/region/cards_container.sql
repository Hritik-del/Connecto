...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518919286642916850)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518919553751916850)
,p_plug_template_id=>wwv_flow_imp.id(53518919286642916850)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518919819465916850)
,p_plug_template_id=>wwv_flow_imp.id(53518919286642916850)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518920183844916851)
,p_plug_template_id=>wwv_flow_imp.id(53518919286642916850)
,p_name=>'Sub Regions'
