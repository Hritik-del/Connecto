...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518988620947916882)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518988901339916882)
,p_plug_template_id=>wwv_flow_imp.id(53518988620947916882)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518989291821916882)
,p_plug_template_id=>wwv_flow_imp.id(53518988620947916882)
,p_name=>'Tabs'
