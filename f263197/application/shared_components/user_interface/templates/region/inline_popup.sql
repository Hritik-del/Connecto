...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518963539330916871)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518963889187916871)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518964153070916871)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518964495139916871)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518964727602916871)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518965081581916871)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518965311082916871)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518965644953916871)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518965913227916872)
,p_plug_template_id=>wwv_flow_imp.id(53518963539330916871)
,p_name=>'Sub Regions'
