...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518968971788916873)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518969276199916873)
,p_plug_template_id=>wwv_flow_imp.id(53518968971788916873)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518969569261916873)
,p_plug_template_id=>wwv_flow_imp.id(53518968971788916873)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518969884566916873)
,p_plug_template_id=>wwv_flow_imp.id(53518968971788916873)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518970113908916873)
,p_plug_template_id=>wwv_flow_imp.id(53518968971788916873)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518970488026916874)
,p_plug_template_id=>wwv_flow_imp.id(53518968971788916873)
,p_name=>'Sub Regions'
