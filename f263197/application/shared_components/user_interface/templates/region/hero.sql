...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53518945453580916862)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518945752626916862)
,p_plug_template_id=>wwv_flow_imp.id(53518945453580916862)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518946002972916863)
,p_plug_template_id=>wwv_flow_imp.id(53518945453580916862)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518946325152916863)
,p_plug_template_id=>wwv_flow_imp.id(53518945453580916862)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518946644146916863)
,p_plug_template_id=>wwv_flow_imp.id(53518945453580916862)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(53518946925958916863)
,p_plug_template_id=>wwv_flow_imp.id(53518945453580916862)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
